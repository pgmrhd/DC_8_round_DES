# dec8.py - pgmrhd
#
# 8-round DES with python
# Encryption, Decryption, Key generation
# https://github.com/pgmrhd/DC_8_round_DES.git
...
# Truncate right half 32 bits
def left32(m):
	pass

# Truncate left half 32 bits
def right32(m):
	pass

# DES rounding for left half
def left_rounding(n, hm):
	pass

# DES rounding for right half
def right_rounding(n, hm):
	pass
...
# Generate the first key with 56 bits
def keyGen(void):
	pass

# Truncate right half 28 bits
def left28(k):
	pass

# Truncate left half 28 bits
def right28(k):
	pass
